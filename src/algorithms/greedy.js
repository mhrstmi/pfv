...
export function greedy(grid, startNode, finishNode) {
  ...
  function sortNodesByHn(unvisitedNodes) {
    unvisitedNodes.sort((nodeA, nodeB) => nodeA.hn_score - nodeB.hn_score);
  }
  ...
  export function greedyGetNodesInShortestPathOrder(finishNode) {
